...
const ImageArticleRouter = Router();
...
ImageArticleRouter.get("/image/:id", (req, res) =>
...
ImageArticleRouter.delete("/image/:id", userAuth.VerifyToken, (req, res) =>
  imageControllers.delete(req, res)
);

export { ImageArticleRouter };
