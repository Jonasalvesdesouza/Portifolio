...
export const UserAdmProvider = ({children}) =>{
    ...
    const socialMediaUpdate = async (
        ...
        try {
            ...
            const newHobbyList = socialMediaList.map(
                socialMedia =>{
    ...
    const hobbyUpdate = async (
        ...
        try {
            ...
            const newHobbyList = hobbyList.map(
                hobby =>{
    ...
    const skillUpdate = async (
        ...
        try {
            ...
            const newSkillList = skillList.map(
                skill =>{
    ...
    const educationUpdate = async (
        ...
        try {
            ...
            const newEducationList = educationList.map(
                education =>{
    ...
    const jobExperienceUpdate = async (
        ...
        try {
            ...
            const newJobExperienceList = jobExperienceList.map(
                jobExperience =>{
    ...
    const jobExperienceDelete = async (
